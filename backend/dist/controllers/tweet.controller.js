...
exports.deletePostedTweets = exports.postScheduledTweets = exports.postTweet = exports.scheduleTweets = void 0;
...
/**
 * Handles posting of scheduled tweets that are due
 * Finds all tweets that haven't been posted yet and are scheduled for now or earlier
 * Posts each tweet and updates its status in the database
 * Returns results of the posting process
 */
